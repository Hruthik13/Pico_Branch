...
import table.Branch.PicoBranch.Repository.PicoBranchRepository;
import table.Branch.PicoBranch.Response.PicoBranchResponse;
import table.Branch.PicoBranch.Specification.PicoBranchSpecification;
...
@Service
public class PicoBranchServiceImpl implements PicoBranchService {
        ...
        try {
            if (checkDuplicate(picoBranch)) {
                ...
                picoBranchResponse.setPicoBranchDTO(
                        new PicoBranchDTO(this.save(picoBranch)));
