...
import table.Branch.PicoBranch.Service.PicoBranchServiceImpl;
...
import table.Branch.PicoBranchDetails.Repository.PicoBranchDetailsRepository;
import table.Branch.PicoBranchDetails.Response.PicoBranchDetailsResponse;
import table.Branch.PicoBranchDetails.Specification.PicoBranchDetailsSpecification;
...
@Service
public class PicoBranchDetailsServiceImpl implements PicoBranchDetailsService {
    @Autowired
    PicoBranchDetailsRepository picoBranchDetailsRepository;

    private static final Logger logger = LoggerFactory.getLogger(PicoBranchServiceImpl.class);
    ...
    public PicoBranchDetailsResponse savePicoBranchDetails(PicoBranchDetails picoBranchDetails) throws Exception {
        ...
        try {
            if (checkDuplicate(picoBranchDetails)) {
                ...
                picoBranchDetailsResponse.setError("Duplicate pico branch details!");
            } else {
...
//                    picoBranchDetailsResponse.setPicoBranchDetailsDTO(picoBranchDetailsRepository.savePicoBranch(picoBranchDetails));
                picoBranchDetailsResponse.setPicoBranchDetailsDTO(
                        new PicoBranchDetailsDTO(this.save(picoBranchDetails)));
