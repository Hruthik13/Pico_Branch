package table.Branch.PicoBranchDetails.DTO;
...
public class PicoBranchDetailsDTO {
    ...
    public PicoBranchDetailsDTO(String id, String clientId, String orgId, String branchId, String branchHeadId, String branchAdminId, String createdBy, Date creationTime, String modifiedBy, Date modificationTime, int isDeleted, String deletedBy, Date deletionTime, String name, String description) {
        this.id = id;
